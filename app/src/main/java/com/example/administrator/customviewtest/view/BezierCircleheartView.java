...
/**
 * @Description:三阶贝塞尔曲线实现圆形变为心型
 * @author: Administrator
 * @Date: 2017/9/8 15:54
 */

public class BezierCircleheartView extends View {
    ...
    public BezierCircleheartView(Context context) {
        super(context);
    }

    public BezierCircleheartView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initPaint();
    }
